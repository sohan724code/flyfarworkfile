                            ...
                            <div class="add-package-box">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="adpack-input">
                                                ...
                                                <input type="text" class="form-control" id="galleryname"
                                                    name="galleryname" placeholder="Hello World">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="adpack-input">
                                                <label for="galleryimage" class="form-label">Upload Image(W:800 X
                                                    H:533)</label>
                                                <input type="file" class="form-control-file" name="galleryimage"
                                                    id="galleryimage">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="adpack-input">
                                                <label for="gallerycreateddate" class="form-label">Created Date</label>
                                                <input type="date" class="form-control" name="gallerycreateddate"
                                        ...
                                        <div class="col-lg-12 d-flex justify-content-end">
                                            <button type="submit" class="save-changes">Add Gallery</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
