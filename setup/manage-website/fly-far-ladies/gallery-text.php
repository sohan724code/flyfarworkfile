        ...
        <main class="container-fluid p-3">
            ...
            <div class="container admin-content">
                ...
                <div class="agsection" id="agsection">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4">
                                    <div class="gal-input">
                                        ...
                                        <input type="text" class="form-control-file" name="changeWatchVideo"
                                            id="changeWatchVideo" placeholder="Video Link">
                    ...
                    $packageText = $_POST["galplaceholdertext"];
                    $packageTitleText = $_POST["changeWatchVideo"];
                    


                        $sql = "INSERT INTO `GalleryContent`(`title`,`video`)
